  ...
  return (
    <div className="min-h-screen bg-[#15151a] ">
      <div className="h-screen max-h-screen flex flex-col">
        {/* Retro TV Container */}
        <div className="relative flex-1 bg-[#15151a] rounded-lg p-6">
          {/* TV Frame */}
          <div className="relative h-full bg-gradient-to-br from-[#a89383] via-[#967c6d] to-[#846b5c] rounded-[45px] p-12 shadow-2xl border-2 border-[#695849]">
            {/* Wood Grain Effect */}
            <div className="absolute inset-0 rounded-[45px] opacity-30 bg-[repeating-linear-gradient(90deg,#000_0px,transparent_2px,transparent_4px)] pointer-events-none" />
            
            {/* Top Speaker Grill */}
            <div className="absolute top-6 left-1/2 -translate-x-1/2 w-48 h-4">
            ...
            <div className="relative h-full flex flex-col">
              {/* Screen Bezel */}
              <div className="flex-1 relative rounded-3xl bg-[#463225] p-6 border-8 border-[#695849] shadow-[inset_0_0_60px_rgba(0,0,0,0.6)]">
                {/* Inner Screen Frame */}
                <div className="absolute inset-2 rounded-2xl border-4 border-[#2a1f1a]" />
                
                {/* Screen Effects */}
                <div className={`absolute inset-4 rounded-xl overflow-hidden ${!isPowered && 'hidden'}`}>
                  {/* Scanlines */}
                ...
                <div 
                  ref={containerRef}
                  className={`relative h-full rounded-xl overflow-hidden transition-opacity duration-1000 ${isPowered ? 'opacity-100' : 'opacity-0'}`}
                >
                ...
                <div className="flex items-center gap-8">
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-[#463225] flex items-center justify-center shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)]">
                      ...
                      />
                      <div className={`absolute -top-1 -right-1 w-3 h-3 rounded-full ${isPowered ? 'bg-green-400' : 'bg-red-500'} animate-pulse`} />
                    </div>
                  </button>
            ...
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2">
              <div className="px-4 py-1 bg-[#463225] rounded-sm text-[#967c6d] text-xs font-mono">RETRO-MATIC</div>
            </div>
          </div>
          ...
          <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-1/2">
            <div className="h-16 bg-gradient-to-b from-[#846b5c] to-[#463225] rounded-t-3xl shadow-lg">
              {/* Wood Grain Effect on Stand */}
              <div className="absolute inset-0 rounded-t-3xl opacity-30 bg-[repeating-linear-gradient(90deg,#000_0px,transparent_2px,transparent_4px)]" />
            </div>
          </div>
        </div>

        {/* Game Title */}
        <h1 className="text-xl text-center text-gray-300 mt-8 mb-4">{game.title}</h1>
      </div>
    </div>
  );
};
